      ...
      <div class="footer-content">
        ...
        <div class="footer-main">
          <div class="footer-section">
            <h4>BLOOP</h4>
            <p>Créez, mixez et produisez vos beats en ligne avec notre studio professionnel.</p>
          ...
          <div class="footer-section">
            ...
            <ul>
              <li><a href="#">Séquenceur multi-pistes</a></li>
              <li><a href="#">Synthétiseurs VST</a></li>
              <li><a href="#">Effets audio</a></li>
              <li><a href="#">Mixage professionnel</a></li>
              <li><a href="#">Export haute qualité</a></li>
            </ul>
          </div>
          ...
          <div class="footer-section">
            ...
            <ul>
              ...
              <li><a href="#">Samples gratuits</a></li>
          ...
          <div class="footer-section">
            ...
            <ul>
              ...
              <li><a href="#">Demande de fonctionnalité</a></li>
              <li><a href="#">Status système</a></li>
            </ul>
          </div>
        ...
        <div class="newsletter-section">
          ...
          <p>Recevez les dernières mises à jour et nouveautés directement dans votre boîte mail.</p>
